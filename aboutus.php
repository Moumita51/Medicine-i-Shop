...
<body>
    ...
    <div class="navbar navbar-default">
        ...
        <div class="container">
                            <h1>About Us</h1>
                            <hr>
                            <h4>Medicine-i-Shop is the biggest digital pharmacy of Bangladesh. Currently the free home delivery service is available to residents of Dhaka city only. Medicine-i-Shop was created with a vision to serve people with a smile, to provide quality service over a virgin sector and become the industry leader in E-commerce healthcare.</h4>
        </div>
