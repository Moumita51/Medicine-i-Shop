                ...
                <div id="row same-height-row">
                    ...
                    <div class="center-responsive col-md-3">
                        <div class="product same-height">
                            <a href="">
                                <img src="admin_area/product_images/seclo.jpg" class="img-responsive">
                            </a>
                            <div class="text">
                                <h3><a href="details.php">Seclo (1 box)
                            </a></h3>
                            <p class="price"> 300</p>
                            </div>
                        </div>
                    ...
                    <div class="center-responsive col-md-3">
                        <div class="product same-height">
                            <a href="">
                                <img src="admin_area/product_images/facemask.jpg" class="img-responsive">
                            </a>
                            <div class="text">
                                <h3><a href="details.php">Facemask (50 pieces)
                            </a></h3>
                            <p class="price"> 150 Taka<?php echo $total ?> </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="center-responsive col-md-3">
                        <div class="product same-height">
                            <a href="">
                                <img src="admin_area/product_images/penspray.jpg" class="img-responsive">
                            </a>
                            <div class="text">
                                <h3><a href="details.php">Penspray
                            </a></h3>
