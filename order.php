...
<?php
    ...
    while($row_cart=mysqli_fetch_array($run_cart)){
        ...
        while($row_pro=mysqli_fetch_array($run_pro)){
            ...
            $insert_cust="insert into customer_order (customer_id, customer_name, product_id, p_title, due_amount,invoice_no,qty,size,order_date,order_status) 
            values('$customer_id','$customer_name',  '$pro_id', '$p_title', '$sub_total','$invoice_no','$qty','$size',NOW(),'$status')";
