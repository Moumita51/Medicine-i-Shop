...
<nav class="navbar navbar-inverse navbar-fixed-top" style="background: black">
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse ">
		...
		<li>
			<a href="index.php?view_ordern">
				<i class="fa fa-fw fa-list"></i>View Order
			</a>
		</li>

		<li>
			<a href="index.php?view_paymentsn">
		...
		<li> <!--Start Here-->
				<a href="#" data-toggle="collapse" data-target="#report">
					<i class="fa fa-fw fa-table"></i>Report</a>
					<i class="fa fa-fw fa-caret-down"></i>
			
			<ul id="report" class="collapse">
				<li>
					<a href="index.php?view_order">Order Report</a>
				</li>
				<li>
					<a href="index.php?view_payments">Payment Report</a>
				</li>
			</ul>
		</li> 
